...
class ConversationStore:
    ...
    def create_thread(self, student_id: str) -> str:
        ...
        self.conn.execute(
            "INSERT INTO thread (id, student_id) VALUES (?, ?)",
    ...
    def append_message(self, thread_id: str, role: str, text: str) -> int:
        """Insert a message with the next sequence number and return that sequence."""
    ...
    def load_history(self, thread_id: str) -> list[dict]:
        """Return messages in sequence order."""
    ...
    def start_run(self, thread_id: str, model: str) -> str:
        """Create a new running run and return its id."""
    ...
    def record_model_step(
        ...
        """Insert a model step and update run token totals atomically."""
    ...
    def record_tool_call(
        ...
        """Insert a tool step and its tool call atomically."""
